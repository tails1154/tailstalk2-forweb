    ...
    <Column gap="lg">
      <CategoryButton.Group>
        <CategoryButton
          ...
          description={
            <Trans>Launch TailsTalk 2 when you log into your computer.</Trans>
          }
        >
        ...
        {autostart() &&
          CheckboxButton(
            ...
            t`TailsTalk 2 will start in the system tray.`,
          )}
        {CheckboxButton(
          "minimiseToTray",
          "cancel_presentation",
          t`Minimise to Tray`,
            t`Instead of closing, TailsTalk 2 will hide in your tray.`,
        )}
        {CheckboxButton(
          "customFrame",
          "web_asset",
          t`Custom window frame`,
            t`Let TailsTalk 2 use its own custom titlebar.`,
        )}
      </CategoryButton.Group>
      ...
      <CategoryButton.Group>
        {CheckboxButton(
          ...
          "groups_2",
          t`Discord RPC`,
            t`Rep TailsTalk 2 using Discord rich presence.`,
        )}
        {CheckboxButton(
          "spellchecker",
          "spellcheck",
      ...
      <CategoryButton.Group>
        ...
        >
          <Trans>TailsTalk 2 for Desktop</Trans>
        </CategoryButton>
      </CategoryButton.Group>
    </Column>
  );
